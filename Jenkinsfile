        ...
        stages{
            stage('Install Maven & test'){
                steps{
                    ...
                    checkout scmGit(branches: [[name: '*/main']], extensions: [], userRemoteConfigs: [[url: 'https://github.com/A00279521/petclinic/']])
            ...
            stage('Build Docker Images'){
                steps{
                    ...
                    dir("spring-petclinic-rest") {
                        script{
                            sh 'docker build -t cathysimms/spring-petclinic-rest:latest .'
                        }
                    }
            ...
            stage('Push images to Hub'){
                steps{
                    script{
                        ...
                        sh 'docker push cathysimms/spring-petclinic-rest:latest'
            ...
            stage('Remove Local Image'){
                steps{
                    sh 'docker rmi -f cathysimms/spring-petclinic-rest:latest'
            ...
            stage("Deploy to docker swarm cluster"){
                steps{
                    ...
                    sshagent(['Docker_Swarm_Manager_SSH']) {
                        ...
                        sh 'ssh -o StrictHostKeyChecking=no ubuntu@3.8.21.159 sudo docker stack deploy --prune --compose-file docker-compose.yml petclinic' 
